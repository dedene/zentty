...
The most semantically important items stable:
...
The UI useful before full GitHub integration is present while preventing multiple competing review-state pipelines from appearing during implementation.
